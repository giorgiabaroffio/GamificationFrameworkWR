...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page4q_miu33q.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld5q" styleClass="wr-submitButtons:ln146q,ln149q  field" property="fld5q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld5q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Description
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld6q" styleClass="wr-submitButtons:ln146q,ln149q  field" property="fld6q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld6q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Score
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld4q_locale" styleClass="wr-submitButtons:ln146q,ln149q  field" property="fld4q_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld4q_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Participation
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld1q" value="true" styleId="sfld1q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld1q" value="false" styleId="sfld1q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.no"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld1q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Reputation
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld2q" value="true" styleId="sfld2q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld2q" value="false" styleId="sfld2q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.no"/>
	      		</html:radio>
	      	</div>
						</td>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld2q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Repeatable * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld3q" value="true" styleId="sfld3q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld3q" value="false" styleId="sfld3q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.no"/>
	      		</html:radio>
	      	</div>
						</td>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld3q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Check Time Elapsed
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld4q" value="true" styleId="sfld4q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld4q" value="false" styleId="sfld4q_0" styleClass="wr-submitButtons:ln146q,ln149q" disabled="false">
	      		  <bean:message key="boolean.no"/>
	      		</html:radio>
	      	</div>
						</td>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld4q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld10q_locale" styleClass="wr-submitButtons:ln146q,ln149q  field" property="fld10q_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld10q_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Active
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
					<html:radio styleClass="wr-submitButtons:ln146q,ln149q  field" property="fld11q_locale" value="true" disabled="false"/>
					<bean:message key="boolean.yes"/>
					<html:radio styleClass="wr-submitButtons:ln146q,ln149q  field" property="fld11q_locale" value="false" disabled="false"/>
					<bean:message key="boolean.no"/>
				</div>
		<c:if test="false">
			<html:hidden property="fld11q_locale"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld11q_locale"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln146q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln146q', pageContext)}">
			<input title="Update" onclick="$('page4q_miu33qFormBean').target='_self'" class="update  button"  style="background-image:url('style/img/Update.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln146q" name="button:ln146q" type="submit" value="Update">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln149q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln149q', pageContext)}">
			<input title="Back" onclick="$('page4q_miu33qFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln149q" name="button:ln149q" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
