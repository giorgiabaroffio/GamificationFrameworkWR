...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page38p.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select styleId="sfld9p" styleClass="wr-submitButtons:ln115p,ln47p  selectionfield" property="sfld9p" disabled="false">
			    ...
			    <html:options property="sfld9pList" labelProperty="sfld9pLabelList"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld9p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Alias * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld8p" styleClass="wr-submitButtons:ln115p,ln47p  field" property="fld8p" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld8p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Text
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld1p" styleClass=" field" cols="72" rows="8" property="fld1p" readonly="false"/>		
				<script type="text/javascript">
					...
					CKEDITOR.replace('fld1p', {
						...
						readOnly : false
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld1p"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln115p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln115p', pageContext)}">
			<input title="Save" onclick="$('page38pFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln115p" name="button:ln115p" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln47p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln47p', pageContext)}">
			<input title="Back" onclick="$('page38pFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln47p" name="button:ln47p" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
