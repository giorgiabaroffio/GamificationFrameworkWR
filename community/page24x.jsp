...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page24x.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld42x_locale" styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld42x_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld42x_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Title * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld46x" styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld46x" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld46x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Description * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld47x" styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld47x" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld47x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Needed Score * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld45x_locale" styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld45x_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld45x_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Image (png)
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:hidden property="fld39x_preload"/>
			<html:file styleId="fld39x" styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld39x" disabled="false" size="25"/>
		<c:if test="${not(empty page24xFormBean.map.fld39x_preload)}">
		  <table>
		    <tr>
		      <td>
		        <html:checkbox styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld39x_clear" disabled="false"/> clear <a target="blank" href="<webratio:BLOB value="${page24xFormBean.map.fld39x_preload}"/>">preview</a>
		      </td>
		    </tr>
		  </table>
		</c:if>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld39x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Active
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
					<html:radio styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld24q_locale" value="true" disabled="false"/>
					<bean:message key="boolean.yes"/>
					<html:radio styleClass="wr-submitButtons:ln194x,ln178x  field" property="fld24q_locale" value="false" disabled="false"/>
		...
		<c:if test="false">
			<html:hidden property="fld24q_locale"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld24q_locale"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln194x', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln194x', pageContext)}">
			<input title="Update" onclick="$('page24xFormBean').target='_self'" class="update  button"  style="background-image:url('style/img/Update.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln194x" name="button:ln194x" type="submit" value="Update">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln178x', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln178x', pageContext)}">
			<input title="Back" onclick="$('page24xFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln178x" name="button:ln178x" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
