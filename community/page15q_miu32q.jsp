...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page15q_miu32q.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select styleId="sfld18q" styleClass="wr-submitButtons:ln165q,ln166q  selectionfield" property="sfld18q" disabled="false">
			    ...
			    <html:options property="sfld18qList" labelProperty="sfld18qLabelList"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld18q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Name * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld14q" styleClass="wr-submitButtons:ln165q,ln166q  field" property="fld14q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld14q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Description
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld21q" styleClass="wr-submitButtons:ln165q,ln166q  field" property="fld21q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld21q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Score
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld13q_locale" styleClass="wr-submitButtons:ln165q,ln166q  field" property="fld13q_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld13q_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Participation * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld5q" value="true" styleId="sfld5q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld5q" value="false" styleId="sfld5q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.no"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld5q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Reputation * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld6q" value="true" styleId="sfld6q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld6q" value="false" styleId="sfld6q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.no"/>
	      		</html:radio>
	      	</div>
						</td>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld6q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Repeatable * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld7q" value="true" styleId="sfld7q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld7q" value="false" styleId="sfld7q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.no"/>
	      		</html:radio>
	      	</div>
						</td>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld7q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Check Time Elapsed
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
	      		<html:radio property="sfld17q" value="true" styleId="sfld17q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.yes"/>
	      		</html:radio>
	      		<html:radio property="sfld17q" value="false" styleId="sfld17q_0" styleClass="wr-submitButtons:ln165q,ln166q" disabled="false">
	      		  <bean:message key="boolean.no"/>
	      		</html:radio>
	      	</div>
						</td>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld17q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld22q_locale" styleClass="wr-submitButtons:ln165q,ln166q  field" property="fld22q_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld22q_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Active
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
					<html:radio styleClass="wr-submitButtons:ln165q,ln166q  field" property="fld25q_locale" value="true" disabled="false"/>
					<bean:message key="boolean.yes"/>
					<html:radio styleClass="wr-submitButtons:ln165q,ln166q  field" property="fld25q_locale" value="false" disabled="false"/>
					<bean:message key="boolean.no"/>
				</div>
		<c:if test="false">
			<html:hidden property="fld25q_locale"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld25q_locale"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln165q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln165q', pageContext)}">
			<input title="Save" onclick="$('page15q_miu32qFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln165q" name="button:ln165q" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln166q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln166q', pageContext)}">
			<input title="Back" onclick="$('page15q_miu32qFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln166q" name="button:ln166q" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
