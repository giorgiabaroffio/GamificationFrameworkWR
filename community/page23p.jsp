...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page23p.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld30p" styleClass="wr-submitButtons:ln74p,ln73p  field" property="fld30p" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld30p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Description
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld31p" styleClass=" field" cols="100" rows="8" property="fld31p" readonly="false"/>		
				<script type="text/javascript">
					...
					CKEDITOR.replace('fld31p', {
						...
						readOnly : false
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld31p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Image
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:hidden property="fld48p_preload"/>
			<html:file styleId="fld48p" styleClass="wr-submitButtons:ln74p,ln73p  field" property="fld48p" disabled="false" size="25"/>
		<c:if test="${not(empty page23pFormBean.map.fld48p_preload)}">
		  <table>
		    <tr>
		      <td>
		        <html:checkbox styleClass="wr-submitButtons:ln74p,ln73p  field" property="fld48p_clear" disabled="false"/> clear <a target="blank" href="<webratio:BLOB value="${page23pFormBean.map.fld48p_preload}"/>">preview</a>
		      </td>
		    </tr>
		  </table>
		</c:if>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld48p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Needed Points
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld32p_locale" styleClass="wr-submitButtons:ln74p,ln73p  field" property="fld32p_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld32p_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Available
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
					<html:radio styleClass="wr-submitButtons:ln74p,ln73p  field" property="fld33p_locale" value="true" disabled="false"/>
					<bean:message key="boolean.yes"/>
					<html:radio styleClass="wr-submitButtons:ln74p,ln73p  field" property="fld33p_locale" value="false" disabled="false"/>
		...
		<c:if test="false">
			<html:hidden property="fld33p_locale"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld33p_locale"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln74p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln74p', pageContext)}">
			<input title="Save" onclick="$('page23pFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln74p" name="button:ln74p" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln73p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln73p', pageContext)}">
			<input title="Back" onclick="$('page23pFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln73p" name="button:ln73p" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
