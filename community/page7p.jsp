...
<c:choose>
  ...
  <c:otherwise>
	...
	<div class="search">
		...
		<html:text   size="25" styleId="fld7p" styleClass="wr-submitButtons:ln89p,ln90p  form-control  field" property="fld7p" readonly="false"/>							
	...
	<div class="">
		...
		<c:if test="${not (empty btFieldError)}">
			<div class="alert alert-danger alert-dismissable">
				...
				<label class="checkbox-inline" for="msfld3p_${status.index}">
				  <html:multibox styleClass="wr-submitButtons:ln89p,ln90p " property="msfld3p" value="${current}" disabled="false" styleId="msfld3p_${status.index}"/>
...
<div class="panel panel-default ">
	...
	<div class="panel-body">
<div class="plain ">
	<div id="enu6p-1510755" class="SliderField">
		<div class="hidden">
			<html:text   size="25" styleId="fld2o" styleClass="wr-submitButtons:ln89p,ln90p  form-control  minfield" property="fld2o" readonly="false"/><script type="text/javascript">
			...
			<html:text   size="25" styleId="fld1o" styleClass="wr-submitButtons:ln89p,ln90p  form-control  maxfield" property="fld1o" readonly="false"/><script type="text/javascript">
		...
		<div class="slider"></div>
			...
			<script>
				$(function() {
				    $( "#enu6p-1510755 .slider" ).slider({
				      range: true,
				      min: 0,
				      max: 9,
				      values: [ ${minValue}, ${maxValue} ],
				      change: function( event, ui ) {
				        $( "#enu6p-1510755 .minfield" ).val( ui.values[ 0 ] );
				        $( "#enu6p-1510755 .maxfield" ).val( ui.values[ 1 ] ).change();
				      },
				      slide: function( event, ui ) {
				            $("#enu6p-1510755 .slider a:first .tip").html(ui.values[0]);
				            $("#enu6p-1510755 .slider a:last .tip").html(ui.values[1]);
				      }
				    });
				    $( "#enu6p-1510755 .minfield" ).val( ${minValue} );
				    $( "#enu6p-1510755 .maxfield" ).val( ${maxValue} );
				    $( "#enu6p-1510755 .slider a:first" ).html( '<div class="tip">${minValue}</div>' );
				    $( "#enu6p-1510755 .slider a:last" ).html( '<div class="tip">${maxValue}</div>' );
				  });
			</script>
	</div>
</div>
