	...
	<h2 class="">Error</h2>
		<div class="plain ">
			...
			<c:if test="${webratio:isTargetAccessible('ln145p', pageContext)}">
											<td>
												 <c:if test="${webratio:isTargetAccessible('ln145p', pageContext)}">
			 			<a title="Ok" id="ln145p" onclick="return ajaxRequest('<webratio:Link link="ln145p" position="index"/>', $H({pressedLink: 'ln145p', sourcePage: 'page26p'}))" class=" link" href="<webratio:Link link="ln145p" position="index"/>">							
						<img title="Ok" alt="Ok" src="style/img/Ok.png" border="0"/>
					</a>
		 			<a title="Ok" id="ln145p" onclick="return ajaxRequest('<webratio:Link link="ln145p" position="index"/>', $H({pressedLink: 'ln145p', sourcePage: 'page26p'}))" class=" link" href="<webratio:Link link="ln145p" position="index"/>">							
					Ok</a>
	</c:if>
