...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page17x.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
...
<div class="left-bar">
	<h2 class="">Choose the Display Sorting</h2>
	<div class="plain ">
		<div class="plain MultiEntryUnit">
				...
				<tr>
					...
					<tr class="headerRow">
						<th class=" header">
								...
								<th align="left" nowrap class=" header">Sort Number</th>
								<th align="left" nowrap class=" header">Area</th>
					</tr>
				<script>multiChoiceMap["meu2x_19024129"] = "all";</script>
							...
							<html:hidden property="value(key)" indexed="true" name="meu2x"/>
								...
								<td>
									<table cellspacing="0" cellpadding="0">
										<tr>
											<td class=" value">
													<html:text styleId="meu2x[${index}].value(fld44x_locale)" indexed="true"  size="15" styleClass="wr-submitButtons:ln183x,ln185x  field" name="meu2x" property="value(fld44x_locale)" readonly="false"/>
											</td>
										</tr>
										<tr>
											<td  class=" error"><html:errors property="meu2x[${index}].value(fld44x_locale)"/></td>
										</tr>
									</table>
								</td>
								<td>
									<table cellspacing="0" cellpadding="0">
										<tr>
											<td class=" value">
													<html:text styleId="meu2x[${index}].value(fld43x)" indexed="true"  size="25" styleClass="wr-submitButtons:ln183x,ln185x  field" name="meu2x" property="value(fld43x)" readonly="true"/>
											</td>
										</tr>
										<tr>
											<td  class=" error"><html:errors property="meu2x[${index}].value(fld43x)"/></td>
										</tr>
									</table>
								</td>
					</tr>
			...
			<c:if test="${webratio:isTargetAccessible('ln183x', pageContext)}">
											<td> <c:if test="${webratio:isTargetAccessible('ln183x', pageContext)}">
			<input title="Update" onclick="$('page17xFormBean').target='_self'" class="update  button"  style="background-image:url('style/img/Update.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln183x" name="button:ln183x" type="submit" value="Update">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln185x', pageContext)}">
											<td> <c:if test="${webratio:isTargetAccessible('ln185x', pageContext)}">
			<input title="Back" onclick="$('page17xFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln185x" name="button:ln185x" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
							</tr>
