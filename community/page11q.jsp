...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page11q.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
   ...
   Text Labels
	...
	<div class="content">
		...
		<div class="page-title<c:if test="${not webratio:isWindow(pageContext)}"> ajaxPopup</c:if>">
			<h1>Create New Administrator User
			</h1>
			<ul class="page-links">
			</ul>
		</div>
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld20q" styleClass="wr-submitButtons:ln116q,ln115q  field" property="fld20q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld20q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Password * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<input type="password" autocomplete="off" id="fld19q" size="25" class="wr-submitButtons:ln116q,ln115q  field" name="fld19q"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld19q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Email * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld18q" styleClass="wr-submitButtons:ln116q,ln115q  field" property="fld18q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld18q"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln116q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln116q', pageContext)}">
			<input title="Save" onclick="$('page11qFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln116q" name="button:ln116q" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln115q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln115q', pageContext)}">
			<input title="Back" onclick="$('page11qFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln115q" name="button:ln115q" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
