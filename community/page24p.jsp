...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page24p.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select styleId="sfld20p" styleClass="wr-submitButtons:ln76p,ln75p  selectionfield" property="sfld20p" disabled="false">
			    ...
			    <html:options property="sfld20pList" labelProperty="sfld20pLabelList"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld20p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Title * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="40" styleId="fld35p" styleClass="wr-submitButtons:ln76p,ln75p  field" property="fld35p" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld35p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Description
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld36p" styleClass=" field" cols="100" rows="8" property="fld36p" readonly="false"/>		
				<script type="text/javascript">
					...
					CKEDITOR.replace('fld36p', {
						...
						readOnly : false
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld36p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Image * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:hidden property="fld47p_preload"/>
			<html:file styleId="fld47p" styleClass="wr-submitButtons:ln76p,ln75p  field" property="fld47p" disabled="false" size="25"/>
		<c:if test="${not(empty page24pFormBean.map.fld47p_preload)}">
		  <table>
		    <tr>
		      <td>
		        <html:checkbox styleClass="wr-submitButtons:ln76p,ln75p  field" property="fld47p_clear" disabled="false"/> clear <a target="blank" href="<webratio:BLOB value="${page24pFormBean.map.fld47p_preload}"/>">preview</a>
		      </td>
		    </tr>
		  </table>
		</c:if>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld47p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Needed Points * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld37p_locale" styleClass="wr-submitButtons:ln76p,ln75p  field" property="fld37p_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld37p_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Available
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
					<html:radio styleClass="wr-submitButtons:ln76p,ln75p  field" property="fld38p_locale" value="true" disabled="false"/>
					<bean:message key="boolean.yes"/>
					<html:radio styleClass="wr-submitButtons:ln76p,ln75p  field" property="fld38p_locale" value="false" disabled="false"/>
		...
		<c:if test="false">
			<html:hidden property="fld38p_locale"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld38p_locale"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln76p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln76p', pageContext)}">
			<input title="Save" onclick="$('page24pFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln76p" name="button:ln76p" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln75p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln75p', pageContext)}">
			<input title="Back" onclick="$('page24pFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln75p" name="button:ln75p" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
