	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
			...
			<c:if test="${webratio:isTargetAccessible('ln161q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln161q', pageContext)}">
			<input title="Yes" onclick="$('page6q_miu31qFormBean').target='_self'" class="yes  button"  style="background-image:url('style/img/Yes.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln161q" name="button:ln161q" type="submit" value="Yes">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln163q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln163q', pageContext)}">
			<input title="No" onclick="$('page6q_miu31qFormBean').target='_self'" class="no  button"  style="background-image:url('style/img/No.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln163q" name="button:ln163q" type="submit" value="No">
	</c:if>
 </td>
			</c:if>
					</tr>
