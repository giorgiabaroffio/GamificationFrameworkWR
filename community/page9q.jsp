		...
		<div class="navbar-header">
	      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#nav-bar-top">
	        ...
	        <span class="icon-bar"></span>
						...
						<a class="home"href="<webratio:Link escapeXml="true" link="page8q.link"/>"><bean:message key="Getting Started"/></a>
	    </div>
...
<div class="panel panel-default ">
	...
	<div class="panel-body">
		<div class="getting-started">
			<dl >
					<dd><c:out value="${dau3q.data.message}" escapeXml="false"/></dd>
			</dl>
