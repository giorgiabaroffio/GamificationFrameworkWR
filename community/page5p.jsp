		...
		<div class="navbar-header">
	      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#nav-bar-top">
			...
			<c:if test="${webratio:isTargetAccessible('page5p.link', pageContext)}">
						<a class="active home" href="<webratio:Link escapeXml="true" link="page5p.link"/>"><bean:message key="Getting Started"/></a>
			</c:if>
	    </div>
...
<div class="panel panel-default ">
	...
	<div class="panel-body">
		<div class="">
			<dl >
					<dd><c:out value="${dau30p.data.message}" escapeXml="false"/></dd>
			</dl>
		</div>
	</div>
</div>     
