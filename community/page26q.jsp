...
<div class="left-bar">
	...
	<c:if test="${webratio:isTargetAccessible('ln89q', pageContext)}">
		 			<a title="Ok " id="ln89q" onclick="return ajaxRequest('<webratio:Link link="ln89q" position="index"/>', $H({pressedLink: 'ln89q', sourcePage: 'page26q'}))"  href="<webratio:Link link="ln89q" position="index"/>">							
					Ok </a>
	</c:if>
			</div>
				<div class="clear"></div>
