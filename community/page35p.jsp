...
<c:out value="${dau6x.data.userName}"/> 
 ...
 <a class="" href="<webratio:Link link="page36p.link"/>">
   Text Mail
					...
					<li class="current"><c:if test="${webratio:isTargetAccessible('page35p.link', pageContext)}">	
   ...
   Text Labels
	...
	<div class="content">
		...
		<div class="page-title<c:if test="${not webratio:isWindow(pageContext)}"> ajaxPopup</c:if>">
			<h1>Manage Containers
			</h1>
			<ul class="page-links">
				<li><c:if test="${webratio:isTargetAccessible('ln147p', pageContext)}">	
 <a class="button" href="<webratio:Link link="ln147p"/>">
   Add container
</a>
			</c:if>
 </li>
