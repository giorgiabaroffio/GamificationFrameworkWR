...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page5q.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select styleId="sfld8q" styleClass="wr-submitButtons:ln25q,ln28q  selectionfield" property="sfld8q" disabled="false">
			    ...
			    <html:options property="sfld8qList" labelProperty="sfld8qLabelList"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld8q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Sort Number * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld8q" styleClass="wr-submitButtons:ln25q,ln28q  field" property="fld8q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld8q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Name * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld7q" styleClass="wr-submitButtons:ln25q,ln28q  field" property="fld7q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld7q"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln25q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln25q', pageContext)}">
			<input title="Save" onclick="$('page5qFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln25q" name="button:ln25q" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln28q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln28q', pageContext)}">
			<input title="Back" onclick="$('page5qFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln28q" name="button:ln28q" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
