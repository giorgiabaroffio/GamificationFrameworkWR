...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page3p.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select styleId="sfld10p" styleClass="wr-submitButtons:ln134p,ln133p  selectionfield" property="sfld10p" disabled="false">
			    ...
			    <html:options property="sfld10pList" labelProperty="sfld10pLabelList"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld10p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Alias * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld16p" styleClass="wr-submitButtons:ln134p,ln133p  field" property="fld16p" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld16p"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Text
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld12p" styleClass=" field" cols="72" rows="8" property="fld12p" readonly="false"/>		
				<script type="text/javascript">
					...
					CKEDITOR.replace('fld12p', {
						...
						readOnly : false
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld12p"/></span></td>
					 	</tr>
			...
			<c:if test="${webratio:isTargetAccessible('ln134p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln134p', pageContext)}">
			<input title="Save" onclick="$('page3pFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln134p" name="button:ln134p" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln133p', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln133p', pageContext)}">
			<input title="Back" onclick="$('page3pFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln133p" name="button:ln133p" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
