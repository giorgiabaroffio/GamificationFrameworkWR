...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page18x.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld53x" styleClass="wr-submitButtons:ln136x,ln66x  field" property="fld53x" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld53x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Name
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld52x" styleClass="wr-submitButtons:ln136x,ln66x  field" property="fld52x" readonly="true"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld52x"/></span></td>
					 	</tr>
			...
			<c:if test="${webratio:isTargetAccessible('ln136x', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln136x', pageContext)}">
			<input title="Update" onclick="$('page18xFormBean').target='_self'" class="update  button"  style="background-image:url('style/img/Update.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln136x" name="button:ln136x" type="submit" value="Update">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln66x', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln66x', pageContext)}">
			<input title="Back" onclick="$('page18xFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln66x" name="button:ln66x" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
