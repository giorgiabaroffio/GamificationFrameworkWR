...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page23x.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
				...
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld66x_locale" styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld66x_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld66x_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Title * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld68x" styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld68x" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld68x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Description * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld69x" styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld69x" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld69x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Needed Score * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld67x_locale" styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld67x_locale" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld67x_locale"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Area * 
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select styleId="sfld7x" styleClass="wr-submitButtons:ln188x,ln223x  selectionfield" property="sfld7x" disabled="false">
			    <html:options property="sfld7xList" labelProperty="sfld7xLabelList"/>
			</html:select>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="sfld7x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Image (png)
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:hidden property="fld63x_preload"/>
			<html:file styleId="fld63x" styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld63x" disabled="false" size="25"/>
		<c:if test="${not(empty page23xFormBean.map.fld63x_preload)}">
		  <table>
		    <tr>
		      <td>
		        <html:checkbox styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld63x_clear" disabled="false"/> clear <a target="blank" href="<webratio:BLOB value="${page23xFormBean.map.fld63x_preload}"/>">preview</a>
		      </td>
		    </tr>
		  </table>
		</c:if>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld63x"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Active
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<div>
					<html:radio styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld23q_locale" value="true" disabled="false"/>
					<bean:message key="boolean.yes"/>
					<html:radio styleClass="wr-submitButtons:ln188x,ln223x  field" property="fld23q_locale" value="false" disabled="false"/>
		...
		<c:if test="false">
			<html:hidden property="fld23q_locale"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld23q_locale"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln188x', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln188x', pageContext)}">
			<input title="Save" onclick="$('page23xFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln188x" name="button:ln188x" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln223x', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln223x', pageContext)}">
			<input title="Back" onclick="$('page23xFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln223x" name="button:ln223x" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
