...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page28q_miu38q.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld39q" styleClass="wr-submitButtons:ln134q,ln135q  field" property="fld39q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld39q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
			...
			<c:forEach var="current" varStatus="status" items="${page28q_miu38qFormBean.map.msfld7qList}">
				<tr>
					<td class=" multiselectionfield">
						<html:multibox styleClass="wr-submitButtons:ln134q,ln135q  multiselectionfield" property="msfld7q" value="${current}" disabled="false" styleId="msfld7q_${status.index}"/>
						   <c:out value="${page28q_miu38qFormBean.map.msfld7qLabelList[status.index]}"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="msfld7q"/></span></td>
					 	</tr>
			...
			<c:if test="${webratio:isTargetAccessible('ln134q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln134q', pageContext)}">
			<input title="Save" onclick="$('page28q_miu38qFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln134q" name="button:ln134q" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln135q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln135q', pageContext)}">
			<input title="Back" onclick="$('page28q_miu38qFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln135q" name="button:ln135q" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
