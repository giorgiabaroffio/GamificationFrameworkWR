...
<div class="container">
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
			<html:form action="form_page3q.do${wrAjax ? '#!ajax=true' : ''}"  enctype="multipart/form-data">
...
<div class="left-bar">
	<h2 class="">New Gamified Application</h2>
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld3q" styleClass="wr-submitButtons:ln20q,ln21q  field" property="fld3q" readonly="false"/>
						</td>
						    </tr>
							<tr>
								<td class="error"><span class=" error"><html:errors property="fld3q"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
			...
			<c:forEach var="current" varStatus="status" items="${page3qFormBean.map.msfld4qList}">
				<tr>
					<td class=" multiselectionfield">
						<html:multibox styleClass="wr-submitButtons:ln20q,ln21q  multiselectionfield" property="msfld4q" value="${current}" disabled="false" styleId="msfld4q_${status.index}"/>
						   <c:out value="${page3qFormBean.map.msfld4qLabelList[status.index]}"/>
							...
							<tr>
								<td class="error"><span class=" error"><html:errors property="msfld4q"/></span></td>
					 	</tr>
					<tr>
						<td colspan="2">
					<table>
			...
			<c:if test="${webratio:isTargetAccessible('ln20q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln20q', pageContext)}">
			<input title="Save" onclick="$('page3qFormBean').target='_self'" class="save  button"  style="background-image:url('style/img/Save.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln20q" name="button:ln20q" type="submit" value="Save">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln21q', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln21q', pageContext)}">
			<input title="Back" onclick="$('page3qFormBean').target='_self'" class="back  button"  style="background-image:url('style/img/Back.png'); background-position: left; background-repeat: no-repeat; padding-left: 20px;" id="button:ln21q" name="button:ln21q" type="submit" value="Back">
	</c:if>
 </td>
			</c:if>
					</tr>
