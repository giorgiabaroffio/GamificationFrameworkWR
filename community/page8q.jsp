...
<div class="container">
	<div class="logo">
        <a href="page9q.do" title="Home" accesskey="1"><img src="BootstrapStyle/css/img/logo-header.png" alt="Home"></a>
    </div>
		...
		<div class="navbar-header">
	      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#nav-bar-top">
	        ...
	        <span class="icon-bar"></span>
						...
						<a class="active home" href="<webratio:Link escapeXml="true" link="page8q.link"/>"><bean:message key="Getting Started"/></a>
	    </div>
...
<div class="panel panel-default ">
	...
	<div class="panel-body">
		<div class="">
			<dl >
					<dd><c:out value="${dau2q.data.message}" escapeXml="false"/></dd>
			</dl>
		</div>
	</div>
</div>     
